...
object Preference_View {
    ...
    fun set_frameLayoutImageModeCheck_visibility(imageModeCheck_visibility: Int, context: Context) {
        ...
        isvisibility_set_edit.putInt("frameLayout_ImageModeCheck_visibility", imageModeCheck_visibility)
            .apply()
    }
    ...
    fun get_frameLayoutImageModeCheck_visibility(context: Context): Int {
        ...
        val isvisibility_get_edit = isvisibility_get.getInt("frameLayout_ImageModeCheck_visibility", 0)
    ...
    fun set_fremeLayout_selfstory_Usagemarks_visibility(context: Context, selfStoryUse: Int) {
        ...
        prefSelfStoryUse_visibility_set_edit.putInt("fremeLayout_selfstory_Usagemarks_visibility", selfStoryUse)
            .apply()
    }
    ...
    fun get_fremeLayout_selfstory_Usagemarks_visibility(context: Context): Int {
        ...
        val prefSelfStoryUse_visibility_get_edit = prefSelfStoryUse_visibility_get.getInt("fremeLayout_selfstory_Usagemarks_visibility", 0x00000000)
    ...
    fun get_RecyclerViewAadapterChangeScore(context: Context): Int {
        ...
        val recyclerViewArrayChange_get_edit = recyclerViewArrayChange_get.getInt("RecyclerViewAadapterChange", 0)
    ...
    fun set_FragmentSetting_switchWidgetSettingPremissonisChecked(
        ...
        isCheckedPref_set_edit.putBoolean("FragmentSetting_switchWidgetSettingPremissonisChecked", boolean)
//        edit1.putString("saveData2", text)
    ...
    fun get_FragmentSetting_switchWidgetSettingPremissonisChecked(context: Context):Boolean {
        ...
        val isCheckedPref_get_edit = isCheckedPref_get.getBoolean("FragmentSetting_switchWidgetSettingPremissonisChecked", false)
//        val new1 = loadData1.getString("saveData2", "OFF\t")
    ...
    fun get_FragmentSetting_switchWidgetSettingPremissonisText(context: Context):String {
        val istextPref_set = PreferenceManager.getDefaultSharedPreferences(context)
        val istextPref_set_edit = istextPref_set.getString("FragmentSetting_switchWidgetSettingPremissonisText", "OFF\t")
    ...
    fun set_FragmentSetting_switchWidgetSettingimageControlisChecked(
        ...
        val isCheckedPref_set_edit = isCheckedPref_set.edit()
        isCheckedPref_set_edit.putBoolean("FragmentSetting_switchWidgetSettingimageControlisChecked", boolean)
            .apply()
    }
    ...
    fun get_FragmentSetting_switchWidgetSettingimageControlisChecked(context: Context):Boolean {
        val isCheckedPref_get = PreferenceManager.getDefaultSharedPreferences(context)
        val isCheckedPref_get_edit = isCheckedPref_get.getBoolean("FragmentSetting_switchWidgetSettingimageControlisChecked", false)
        return isCheckedPref_get_edit
    }
    ...
    fun set_FragmentSetting_switchWidgetSettingimageControlisText(
        ...
        isTextPref_set_edit.putString("FragmentSetting_switchWidgetSettingimageControlisText", textOnoff)
            .apply()
    }
    ...
    fun get_FragmentSetting_switchWidgetSettingimageControlisText(context: Context):String {
        ...
        val isTextPref_get_edit = isTextPref_get.getString("FragmentSetting_switchWidgetSettingimageControlisText", "OFF\t")
