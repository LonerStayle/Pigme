...
import kr.loner.pigme.databinding.RecyclerviewThirdImagemodeSelectHolderBinding
...
class RecyclerViewDialogInDialogAdapter(
    ...
    inner class ImageItemViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        val binding =
            DataBindingUtil.bind<RecyclerviewThirdImagemodeSelectHolderBinding>(view)
